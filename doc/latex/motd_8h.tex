...
\#define {\bfseries COLOR\+\_\+\+MAGENTA}~\char`\"{}\textbackslash{}033\mbox{[}38;5;197m\char`\"{}
...
\#define {\bfseries COLOR\+\_\+\+RESET}~\char`\"{}\textbackslash{}033\mbox{[}0m\char`\"{}
\item 
...
typedef struct \mbox{\hyperlink{structfsinfo}{fsinfo}} {\bfseries fsinfo}
\end{DoxyCompactItemize}
...
basic I/O malloc, free true, false, bool type strings utils time utilities POSIX api filesystem stats system relese, version, etc length of time\+\_\+string 
